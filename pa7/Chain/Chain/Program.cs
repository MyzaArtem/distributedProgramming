...
namespace Chain
{
    class Program
    {
        ...
        private static async Task StartInitiatorProcess(int listeningPort, string nextHost, int nextPort)
        {
            ...
            Console.WriteLine("Sending value: {0}", x);

            x = ReceiveData(handler);

            Console.WriteLine("Received value: {0}", x);
            ...
            Console.WriteLine("Received max value: {0}", x);

            Console.WriteLine("Biggest: {0}", x);
        ...
        private static async Task StartProcess(int listeningPort, string nextHost, int nextPort)
        {
            ...
            Console.WriteLine("Sending value: {0}", maxNumber);
            ...
            Console.WriteLine("Sending max value: {0}", x);
